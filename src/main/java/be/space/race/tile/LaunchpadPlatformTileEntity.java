...
public class LaunchpadPlatformTileEntity extends TileEntityMultiblock<LaunchpadMultiblockData> {
    public LaunchpadPlatformTileEntity(BlockPos pos, BlockState state) {
        this(SpaceBlocks.LAUNCHPAD_PLATFORM, pos, state);
    }

    public LaunchpadPlatformTileEntity(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
