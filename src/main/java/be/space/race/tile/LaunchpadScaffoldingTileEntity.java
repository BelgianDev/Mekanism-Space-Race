...
public class LaunchpadScaffoldingTileEntity extends TileEntityMultiblock<LaunchpadMultiblockData> {
    public LaunchpadScaffoldingTileEntity(BlockPos pos, BlockState state) {
        this(SpaceBlocks.LAUNCHPAD_SCAFFOLDING, pos, state);
    }

    public LaunchpadScaffoldingTileEntity(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
